...
# pylint: disable=redefined-outer-name, no-self-use, bad-continuation, unused-import
...
from markers import *
from confluencer import __version__ as version
from confluencer import __main__ as main
from confluencer import commands
